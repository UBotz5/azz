        ...
        try {
            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    m.isCommand = true
                    let xp = 'exp' in plugin ? parseInt(plugin.exp) : 99999 // XP Earning per command
                    if (xp > 99999) m.reply('Ngecit -_-') // Hehehe
                    else m.exp += xp
...
⬡ *NGOTAK LAH BODOH KAU TU BUKAN OWNER🗿*
╰─────────────────֍`,
    owner: `╭─֍〔 ıll *OWNER* llı 〕֍─
⬡ *NGOTAK LAH BODOH KAU TU BUKAN OWNER🗿*
╰─────────────────֍`,
    mods: `╭─֍〔 ıll *OWNER* llı 〕֍─
⬡ *NGOTAK LAH BODOH KAU TU BUKAN MODERATOR🗿*
╰─────────────────֍`,
    premium: `╭─֍〔 ıll *PREMIUM* llı 〕֍─
⬡ *KAU YAK BUKAN MEMBER PREMIUM AWOKAWOAK, MAKANYA BELI PREMIUM JANGAN GRATISAN MULU*
╰─────────────────֍`,
    group: `╭─֍〔 ıll *GROUP* llı 〕֍─
⬡ *KAU TENGOKAN ITU KHUSUS GRUP? TROS GUNE KAU CHAT DI PRIBADI APE?:V*
╰─────────────────֍`,
    private: `╭─֍〔 ıll *PRIVATE* llı 〕֍─
⬡ *GUNE DI CHAT PRIBADI YAK!*
╰─────────────────֍`,
    admin: `╭─֍〔 ıll *ADMIN GROUP* llı 〕֍─
⬡ *KAU BUKAN ADMIN JGAN SOK KERAS🗿*
╰─────────────────֍`,
    botAdmin: `╭─֍〔 ıll *WARNING* llı 〕֍─
⬡ *BOT DAH MASUK TAPI GAK ADMIN LAWACK LO MIN🗿*
╰─────────────────֍`,
